...
use App\Http\Livewire\Admin\AdnimAddCategoryComponent;
...
use App\Http\Livewire\User\UserRviewComponent;
...
Route::group(
    ...
    Route::middleware(['auth:sanctum', 'verified'])->group(function () {
        ...
        Route::get('/user/review/{order_item_id}',UserRviewComponent::class)->name('user.review');
    ...
    Route::middleware(['auth:sanctum', 'verified', 'authadmin'])->group(function () {
        ...
        Route::get('/admin/category/add',AdnimAddCategoryComponent::class)->name('admin.addcategory');
        ...
        Route::get('/admin/product-attribute',AdminProductAttributeComponent::class)->name('admin.productAttribute');
