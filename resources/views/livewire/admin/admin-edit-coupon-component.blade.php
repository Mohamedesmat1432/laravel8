        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="card-header-home bold {{__('messages.text')}}">
                    {{__('messages.Edit Coupon')}}
                    <a href="{{route('admin.coupon')}}" class="btn btn-success {{__('messages.floatx')}} rounded">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-light">
                        <form class="form-horizontal {{__('messages.text')}}" enctype="multipart/form-data" wire:submit.prevent="updateCoupon">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control rounded bold" wire:model="type">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="{{__('messages.Coupon Value')}}" class="form-control input-md w-100" wire:model="value"/>
